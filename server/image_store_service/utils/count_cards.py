...
count_objects('/media/FourT/uniquare/local/uniquare_multilables/tfod1/workspace/training_demo/images/Mode_all_quadrat', labels)                                   
#count_objects('/media/FourT/uniquare/local/data/Cards_August_3_2020/Training/', labels)                                   
'''
labels = [
    'AT_A_0',
    'AT_A_90',
